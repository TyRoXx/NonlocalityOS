...
async fn hello_world() {
    ...
    ));
    {
        ...
        assert_eq!(
            ...
            "  literal(DeepTree { blob: TreeBlob { content: b\"\" }, references: DeepTreeChildren { references: [DeepTree { blob: TreeBlob { content: b\"Hello, world!\\n\" }, references: DeepTreeChildren { references: [] } }] } })"),
